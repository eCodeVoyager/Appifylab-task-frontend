    ...
    <div className="_feed_inner_timeline_post_area _b_radious6 _padd_b24 _padd_t24 _mar_b16">
      <div className="_feed_inner_timeline_content _padd_r24 _padd_l24">
        <div className="_feed_inner_timeline_post_top">
          <div className="_feed_inner_timeline_post_box">
            <div className="_feed_inner_timeline_post_box_image">
              <img
                src={post.authorImage || "assets/images/post_img.png"}
                alt=""
                className="_post_img"
              />
            </div>
            <div className="_feed_inner_timeline_post_box_txt">
              <h4 className="_feed_inner_timeline_post_box_title">
                {post.authorName || "Karim Saif"}
              </h4>
              <p className="_feed_inner_timeline_post_box_para">
                {post.time || "5 minute ago"} .
                <a href="#0">{post.privacy || "Public"}</a>
              </p>
            </div>
          </div>
        ...
        <h4 className="_feed_inner_timeline_post_title">
          {post.title || "-Healthy Tracking App"}
        </h4>
        {post.image && (
      ...
      <div className="_feed_inner_timeline_total_reacts _padd_r24 _padd_l24 _mar_b26">
        ...
        <div className="_feed_inner_timeline_total_reacts_txt">
          <p className="_feed_inner_timeline_total_reacts_para1">
            <a href="#0">
              <span>{post.commentCount || "12"}</span> Comment
            </a>
          </p>
          <p className="_feed_inner_timeline_total_reacts_para2">
            <span>{post.shareCount || "122"}</span> Share
          </p>
        </div>
      </div>
